  ...
  <MainLayout>
    ...
    <section class="card">
      <form @submit.prevent='updateBrand'>
        ...
        <label>{{ $t('code') }}: <input v-model='brand.code' name='code' type='text'/></label>
        <label>{{ $t('name') }}: <input v-model='brand.name' autocomplete='false' name='name' type='text'/></label>
        <label>{{ $t('description') }}: <input v-model='brand.description' name='factorToBase'/></label>
        <label>{{ $t('enabled') }}: <input v-model="brand.enabled" name="enabled" type="checkbox"></label>
