...
public interface BrandRepository extends JpaRepository<Brand, Long> {
    ...
    @Query("""
            ...
            ORDER BY p.id""")
    Slice<BrandItem> getAllItems(Pageable pageable);
...
@Query("""
            ...
            ORDER BY p.id""")
    Slice<BrandItem> getItemsSearched(Pageable pageable, @Param("search") String search);
    ...
    @Query("""
            ...
            ORDER BY p.id""")
    BrandItem getItemById(@Param("id") Long id);
}
