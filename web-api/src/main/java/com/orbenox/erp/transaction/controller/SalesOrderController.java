...
public class SalesOrderController {
    ...
    @PreAuthorize("hasPermission('SALES_ORDER', 'SUBMIT')")
    ...
    @PreAuthorize("hasPermission('SALES_ORDER', 'APPROVE')")
    ...
    @PreAuthorize("hasPermission('SALES_ORDER', 'REJECT')")
    ...
    @PreAuthorize("hasPermission('SALES_ORDER', 'CLOSE')")
    ...
    @PreAuthorize("hasPermission('SALES_ORDER', 'CANCEL')")
